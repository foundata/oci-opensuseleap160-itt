# OCI Image: openSUSE Leap 16.0, Integration Test Target (ITT)
...
2. Use the image you built earlier or pull the image from a registry:
   - [Quay](https://quay.io/repository/foundata/opensuseleap160-itt):
     ...
     ```
   - [Docker Hub](https://hub.docker.com/r/foundata/opensuseleap160-itt):
     ```bash
     podman pull docker.io/foundata/opensuseleap160-itt:latest
     ```
3. Run a container from the image:
   ```bash
   podman run --detach --systemd=always opensuseleap160-itt:latest "/usr/sbin/init"
   ```
